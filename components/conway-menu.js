  ...
  return (
    <Popover placement="top-end" trigger="hover">
      ...
      <PopoverContent bg={useColorModeValue('#f0e7db', '#202023')}>
        ...
        <PopoverBody>
          The background of this page is a rendering of John Conway&apos;s Game
          of Life. It&apos;s a sequence of steps in which each cell either come
          alive or dies based on how many neighbors it has.
          <br />
          <br />
          <list>
            <ul>
              &bull; A live cell with fewer than 2 neighbors dies to
              underpopulation
            </ul>
            <ul>
              &bull; A live cell with fewer than 2 neighbors dies to
        ...
        <PopoverFooter
          ...
          alignItems="center"
        >
          <Box fontSize="sm">Generate random initial condition</Box>
          <IconButton
